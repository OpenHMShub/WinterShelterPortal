...
COALESCE(TableReservations.reservations , 0) as noOfReservations , 'None' as associatedProgram, 'None' as WaitingList,
...
a.zipCode as zipCode, a.beds as beds, a.rooms as rooms, a.phone as phone
